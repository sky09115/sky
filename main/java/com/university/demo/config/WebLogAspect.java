...
public class WebLogAspect {
    ...
    @Pointcut("@annotation(com.university.demo.anotation.SysLog)")
    public void webLog(){}
...
//    }
    ...
    public void doBefore(JoinPoint joinPoint) throws Throwable {
        ...
        com.university.demo.entity.Log log = new Log();
        ...
        if(Arrays.toString(joinPoint.getArgs()).length()>255){
            log.setArgs(Arrays.toString(joinPoint.getArgs()).substring(0,254));
        }else{
