...
public class MovieDetialController extends BaseController<MovieDetail> {

    protected String[] search_fields = new String[]{"title", "casts", "directors"};
    ...
    public ServerResponse list(HttpServletRequest request,
        ...
        Page<MovieDetail> pages = new Page<>(page, limit);
        MyWrapper<MovieDetail> wrapperFactory = new MyWrapper<>();
        QueryWrapper<MovieDetail> wrapper = wrapperFactory.init(request, search, search_fields, search_filter);
        IPage<MovieDetail> iPage = baseSerivce.page(pages, wrapper);
