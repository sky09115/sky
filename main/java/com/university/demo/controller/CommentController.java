...
public class CommentController {
    ...
    @PostMapping("/modify")
    public ServerResponse modify(@RequestBody Comment record) {
    ...
    public ServerResponse querys(@PathVariable("page") Integer page,
        ...
        QueryWrapper<Comment> wrapper = new QueryWrapper<Comment>().eq("deleted",false);
        IPage<Comment> iPage = commentService.page(pages, wrapper);
    ...
    @PostMapping("/add")
    public ServerResponse add(@RequestBody Comment record) {
//        news.setStar(0);
//        news.setThumb(0);
