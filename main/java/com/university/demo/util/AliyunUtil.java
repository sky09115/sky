...
//    @Value("${aliyun.oss.file.accessKeyId}")
    private static String accessKeyId = "LTAI4FbgffEVhVHiUrw71eu2";

//    @Value("${aliyun.oss.file.accessKeySecret}")
    private static String accessKeySecret = "RyWJQT7a7iH002tkSSwv58QPEfxzCH";

//    @Value("${aliyun.oss.file.bucketName}")
    private static String bucketName = "zzuoss";
